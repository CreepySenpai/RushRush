            ...
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <div class="display-4 text-left">
                        Đã Tìm Thấy {{$productCount}} Sản Phẩm Theo {{$productName}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            ...
                            <a href="{{ asset('/addtocart/' . $product->product_id) }}" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Thêm Vào Giỏ Hàng</a>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="col-12 pb-1">
                    {{ $productFounds->links('vendor/pagination/default') }}
                </div>
            </div>
        </div>
        <!-- Shop Product End -->
