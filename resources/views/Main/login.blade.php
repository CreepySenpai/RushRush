                    ...
                    <form class="form-horizontal m-t-20" id="loginform" method="post">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input name="email" type="email" class="form-control form-control-lg" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="form-group form-check">
                            <label class="form-check-label animated-checkbox" for="rememberMe">
                                <input name="remember" type="checkbox" class="form-check-input" id="rememberMe" value="remember">
                                <span></span>
                                Remember Me
                            </label>
